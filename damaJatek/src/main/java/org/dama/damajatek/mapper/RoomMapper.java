...
public class RoomMapper {
    ...
    public static RoomInfoDtoV1 createRoomInfoDtoV1(Room room, AppUser host) {
    ...
    public static RoomInfoDtoV1 createRoomInfoDtoV1(Room room, AppUser host, AppUser opponent) {
        return RoomInfoDtoV1.builder()
                .id(room.getId())
                .name(room.getName())
                .host(createAppUserInfoDtoV1(host))
